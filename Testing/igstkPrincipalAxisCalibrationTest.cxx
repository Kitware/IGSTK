...
int igstkPrincipalAxisCalibrationTest( int, char * [] )
{
  ...
  PrincipalAxisCalibrationType::Pointer principal = PrincipalAxisCalibrationType::New();
  ...
  // Set the desired orientation of the tool, normal is a bit shifted for adjust test
  axis[0] = 0.0;
  axis[1] = 0.0;
  axis[2] = 1.0;
  normal[0] = 0.0;
