/*=========================================================================
  ...
  Module:    LiverTumorThresholdLevelSetSegmentationModule.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
namespace ISIS {
	...
	LiverTumorSegmentationModule::LiverTumorSegmentationModule()
	{	
		...
		m_InitialNeighborhoodRadius = 2.0f;
	...
	const LiverTumorSegmentationModule::OutputImageType *
		LiverTumorSegmentationModule
		::GetOutput()
	{
	...
	itk::Notifier* LiverTumorSegmentationModule::GetNotifier( void )
	{
		return m_Notifier;
	}
	
	
	void LiverTumorSegmentationModule::Execute()
	{
		try
		{
	...
	int LiverTumorSegmentationModule::GetElapsedIterations( void )
	{
