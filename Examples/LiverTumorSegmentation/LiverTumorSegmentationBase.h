...
//  typedef signed short   PixelType;
  ...
  typedef ISIS::LiverTumorSegmentationModule::InputImageType    InputImageType;

  typedef ISIS::LiverTumorSegmentationModule::OutputImageType   OutputImageType;
...
protected:
  ...
  ISIS::LiverTumorSegmentationModule	  m_LiverTumorSegmentationModule;
