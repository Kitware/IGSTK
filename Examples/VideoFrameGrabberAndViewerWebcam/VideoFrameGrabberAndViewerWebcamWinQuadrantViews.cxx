/*=========================================================================
  ...
  Module:    VideoFrameGrabberAndViewerWebcamWinQuadrantViews.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "VideoFrameGrabberAndViewerWebcamWinQuadrantViews.h"

namespace igstk
{

VideoFrameGrabberAndViewerWebcamWinQuadrantViews::VideoFrameGrabberAndViewerWebcamWinQuadrantViews(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
VideoFrameGrabberAndViewerWebcamWinQuadrantViews::~VideoFrameGrabberAndViewerWebcamWinQuadrantViews()
{
  delete m_VideoWidget;
}

unsigned long VideoFrameGrabberAndViewerWebcamWinQuadrantViews::AddObserver(
  const ::itk::EventObject & event, ::itk::Command * observer )
{
  return m_Reporter->AddObserver( event, observer );
}

void VideoFrameGrabberAndViewerWebcamWinQuadrantViews::RemoveObserver( unsigned long tag )
{
  m_Reporter->RemoveObserver( tag );
}

void VideoFrameGrabberAndViewerWebcamWinQuadrantViews::RemoveAllObservers()
{
  m_Reporter->RemoveAllObservers();
}

int
VideoFrameGrabberAndViewerWebcamWinQuadrantViews
