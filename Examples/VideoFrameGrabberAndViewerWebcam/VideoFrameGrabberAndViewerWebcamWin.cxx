...
VideoFrameGrabberAndViewerWebcamWin::VideoFrameGrabberAndViewerWebcamWin()
{
  ...
  */
  ...
  // The ErrorObserver is implemented in \code{VideoFrameGrabberAndViewerWebcamWin.h}.
  //
  // EndLatex
...
void VideoFrameGrabberAndViewerWebcamWin::RequestInitialize()
{
  ...
  // The \doxygen{WebcamWinVideoImager} derive from \doxygen{VideoImager} and implement device
  // specific communication. For device specific implementations  see \doxygen{WebcamWinVideoImager.h}
  ...
  else
  {
    // BeginLatex
    //
    // Next we create an \doxygen{WebcamWinVideoImagerTool} and set frame dimensions,
