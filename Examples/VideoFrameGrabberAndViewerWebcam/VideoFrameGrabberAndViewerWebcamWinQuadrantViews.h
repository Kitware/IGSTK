/*=========================================================================
  ...
  Module:    VideoFrameGrabberAndViewerWebcamWinQuadrantViews.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __VideoFrameGrabberAndViewerWebcamWinQuadrantViews_h
#define __VideoFrameGrabberAndViewerWebcamWinQuadrantViews_h
...
class VideoFrameGrabberAndViewerWebcamWinQuadrantViews : public Fl_Group {
public:

  VideoFrameGrabberAndViewerWebcamWinQuadrantViews(int X, int Y, int W, int H, const char *L = 0);

  virtual ~VideoFrameGrabberAndViewerWebcamWinQuadrantViews(void);
