/*=========================================================================
  ...
  Module:    itkPETDicomImageReader.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkPETDicomImageReader_h
...
/** \class PETDicomImageReader
 * 
 * \brief This class reads PET DICOM files. 
 *
 */
template< class TImageType >
class PETDicomImageReader : public  Object
{

public: 
  /** Standard class typedef. */
  typedef PETDicomImageReader       Self;
  ...
  itkTypeMacro( PETDicomImageReader, Object );
...
private:
  ...
  PETDicomImageReader(const Self&);    //purposely not implemented
...
#include "itkPETDicomImageReader.txx"
#endif

#endif // __itkPETDicomImageReader_h
