...
How to build:
1. Install CMake
1. Download, configure (using CMake), and compile ITK, VTK, FLTK
2. Download and compile IGSTK and then IGSTKSandbox. When configure with CMake, turn on IGSTK_USE_FLTK and IGSTKSandbox_USE_FLTK, and set the proper include directotries.

If you want to use Micron tracker with this application, make sure you have configured the Sandbox with IGSTKSandbox_USE_MicronTracker ON

Also make sure IGSTKSandbox_BUILD_EXAMPLES is ON

If you follow this process and successfully build the IGSTKSandbox, the final binary file should be in your “Sandbox-Bin/bin/” or sub directory
