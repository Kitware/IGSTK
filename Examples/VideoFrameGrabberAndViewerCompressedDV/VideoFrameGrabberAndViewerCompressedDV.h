/*=========================================================================
  ...
  Module:    VideoFrameGrabberAndViewerCompressedDV.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __VideoFrameGrabberAndViewerCompressedDV_h
#define __VideoFrameGrabberAndViewerCompressedDV_h

#include "VideoFrameGrabberAndViewerCompressedDVGUI.h"
...
namespace igstk{
/** \class VideoFrameGrabberAndViewerCompressedDV
*
* \brief Implementation class for VideoFrameGrabberAndViewerCompressedDVGUI.
*
* This class implements the main application.
*
*/
class VideoFrameGrabberAndViewerCompressedDV : public VideoFrameGrabberAndViewerCompressedDVGUI
{
public:

  /** Typedefs */
  igstkStandardClassBasicTraitsMacro( VideoFrameGrabberAndViewerCompressedDV,
                                      VideoFrameGrabberAndViewerCompressedDVGUI );
  ...
  VideoFrameGrabberAndViewerCompressedDV();
  virtual ~VideoFrameGrabberAndViewerCompressedDV();

private:

  VideoFrameGrabberAndViewerCompressedDV(const Self&); // purposely not implemented
