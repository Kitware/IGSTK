/*=========================================================================
  ...
  Module:    VideoFrameGrabberAndViewerCompressedDVView.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "VideoFrameGrabberAndViewerCompressedDVView.h"

namespace igstk
{

VideoFrameGrabberAndViewerCompressedDVView::VideoFrameGrabberAndViewerCompressedDVView(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
VideoFrameGrabberAndViewerCompressedDVView::~VideoFrameGrabberAndViewerCompressedDVView()
{
