/*=========================================================================
  ...
  Module:    UltrasoundCalibrationWizardQuadrantViews.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __UltrasoundCalibrationWizardQuadrantViews_h
#define __UltrasoundCalibrationWizardQuadrantViews_h
...
class UltrasoundCalibrationWizardQuadrantViews : public Fl_Group {
public:

  UltrasoundCalibrationWizardQuadrantViews(int X, int Y, int W, int H, const char *L = 0);
