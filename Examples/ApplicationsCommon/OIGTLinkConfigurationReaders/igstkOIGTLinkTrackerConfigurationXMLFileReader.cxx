/*=========================================================================
  ...
  Module:    igstkOIGTLinkTrackerConfigurationXMLFileReader.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
void 
OIGTLinkTrackerConfigurationXMLFileReader::ProcessToolConnection() 
throw ( FileFormatException )
{
  unsigned ipPort;
  std::string hostName;
...
OIGTLinkDataType &toolNamesAndConnections )
{
