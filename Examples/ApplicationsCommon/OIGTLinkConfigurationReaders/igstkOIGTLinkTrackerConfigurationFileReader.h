...
public:
  ...
  public:
    ...
    {
      if( dynamic_cast<const igstk::OIGTLinkTrackerConfigurationFileReader::ReadSuccessEvent *>( &event) )
      {
        m_GotSuccess = true;
      }
      ...
      else if( dynamic_cast<const igstk::OIGTLinkTrackerConfigurationFileReader::UnexpectedTrackerTypeEvent *>( &event) )
      {
