...
namespace igstk
{
/** \class OIGTLinkTrackerConfigurationFileReader
 * 
 ...
 *
 */
class OIGTLinkTrackerConfigurationFileReader : public Object 
{
public:

  /**Macro with standard traits declarations (Self, SuperClass, state machine 
    * etc.). */
  igstkStandardClassTraitsMacro( OIGTLinkTrackerConfigurationFileReader, Object )
   ...
   */
  struct OIGTLinkConfigurationDataType 
    {
    TrackerConfigurationDataType m_TrackerConfiguration;
    OIGTLinkDataType m_ToolNamesAndConnections;
    };

  typedef OIGTLinkConfigurationDataType* OIGTLinkConfigurationDataPointerType;
   ...
   * OIGTLinkConfigurationDataEvent if the data was loaded, otherwise an 
   ...
   *  data is available. */
  igstkLoadedEventMacro( OIGTLinkConfigurationDataEvent, IGSTKEvent,
  ...
  public:
    ...
    void Execute(const itk::Object *caller, const itk::EventObject & event)
      {
      if( dynamic_cast<const igstk::OIGTLinkTrackerConfigurationFileReader::
        ReadSuccessEvent *>( &event) )
        {
        m_GotSuccess = true;
        }
      else if( const igstk::OIGTLinkTrackerConfigurationFileReader::
        ReadFailureEvent *rfe = 
        dynamic_cast<const igstk::OIGTLinkTrackerConfigurationFileReader::
        ReadFailureEvent *>( &event) )
        {
        m_GotFailure = true;
        m_FailureMessage = rfe->Get();
        }
      else if( dynamic_cast<const igstk::OIGTLinkTrackerConfigurationFileReader::
...
private:
  ...
  OIGTLinkConfigurationDataType m_OIGTLinkTrackerConfiguration;
...
#endif //__igstkOIGTLinkTrackerConfigurationFileReader_h
