/*=========================================================================
  ...
  Module:    WorkingVolumeTesterQuadrantViews.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "WorkingVolumeTesterQuadrantViews.h"

namespace igstk
{

WorkingVolumeTesterQuadrantViews::WorkingVolumeTesterQuadrantViews(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
WorkingVolumeTesterQuadrantViews::~WorkingVolumeTesterQuadrantViews()
{
...
unsigned long WorkingVolumeTesterQuadrantViews::AddObserver(
  const ::itk::EventObject & event, ::itk::Command * observer )
{
  return m_Reporter->AddObserver( event, observer );
}

void WorkingVolumeTesterQuadrantViews::RemoveObserver( unsigned long tag )
{
  m_Reporter->RemoveObserver( tag );
}

void WorkingVolumeTesterQuadrantViews::RemoveAllObservers()
{
