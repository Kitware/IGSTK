/*=========================================================================
  ...
  Module:    WorkingVolumeTesterQuadrantViews.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __WorkingVolumeTesterQuadrantViews_h
#define __WorkingVolumeTesterQuadrantViews_h
...
class WorkingVolumeTesterQuadrantViews : public Fl_Group {
public:

  WorkingVolumeTesterQuadrantViews(int X, int Y, int W, int H, const char *L = 0);

  virtual ~WorkingVolumeTesterQuadrantViews(void);
