/*=========================================================================
  ...
  Module:    VideoFrameGrabberAndViewerQuadrantViews.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "VideoFrameGrabberAndViewerQuadrantViews.h"

namespace igstk
{

VideoFrameGrabberAndViewerQuadrantViews::VideoFrameGrabberAndViewerQuadrantViews(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
VideoFrameGrabberAndViewerQuadrantViews::~VideoFrameGrabberAndViewerQuadrantViews()
{
  delete m_VideoWidget;
}

unsigned long VideoFrameGrabberAndViewerQuadrantViews::AddObserver(
  const ::itk::EventObject & event, ::itk::Command * observer )
{
  return m_Reporter->AddObserver( event, observer );
}

void VideoFrameGrabberAndViewerQuadrantViews::RemoveObserver( unsigned long tag )
{
  m_Reporter->RemoveObserver( tag );
}

void VideoFrameGrabberAndViewerQuadrantViews::RemoveAllObservers()
{
  m_Reporter->RemoveAllObservers();
}

int 
VideoFrameGrabberAndViewerQuadrantViews
