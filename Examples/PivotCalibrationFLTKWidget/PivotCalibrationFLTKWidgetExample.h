#ifndef _PIVOT_CALIBRATION_FLTK_WIDGET_EXAMPLE_H_
#define _PIVOT_CALIBRATION_FLTK_WIDGET_EXAMPLE_H_
...
class PivotCalibrationFLTKWidgetExample : public PivotCalibrationFLTKWidgetExampleUI
{
public:
