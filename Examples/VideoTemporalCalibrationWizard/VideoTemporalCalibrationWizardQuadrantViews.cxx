/*=========================================================================
  ...
  Module:    VideoTemporalCalibrationWizardQuadrantViews.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "VideoTemporalCalibrationWizardQuadrantViews.h"

namespace igstk
{

VideoTemporalCalibrationWizardQuadrantViews::VideoTemporalCalibrationWizardQuadrantViews(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
VideoTemporalCalibrationWizardQuadrantViews::~VideoTemporalCalibrationWizardQuadrantViews()
{
  delete m_VideoWidget;
  delete m_3DWidget;
}

unsigned long VideoTemporalCalibrationWizardQuadrantViews::AddObserver(
  const ::itk::EventObject & event, ::itk::Command * observer )
{
  return m_Reporter->AddObserver( event, observer );
}

void VideoTemporalCalibrationWizardQuadrantViews::RemoveObserver( unsigned long tag )
{
  m_Reporter->RemoveObserver( tag );
}

void VideoTemporalCalibrationWizardQuadrantViews::RemoveAllObservers()
{
  m_Reporter->RemoveAllObservers();
}

int 
VideoTemporalCalibrationWizardQuadrantViews
