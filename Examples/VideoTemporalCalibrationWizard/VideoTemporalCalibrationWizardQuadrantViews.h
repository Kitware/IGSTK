/*=========================================================================
  ...
  Module:    VideoTemporalCalibrationWizardQuadrantViews.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __VideoTemporalCalibrationWizardQuadrantViews_h
#define __VideoTemporalCalibrationWizardQuadrantViews_h
...
class VideoTemporalCalibrationWizardQuadrantViews : public Fl_Group {
public:

  VideoTemporalCalibrationWizardQuadrantViews(int X, int Y, int W, int H, const char *L = 0);

  virtual ~VideoTemporalCalibrationWizardQuadrantViews(void);
