/*=========================================================================
  ...
  Module:    BronchoscopyNavigatorQuadrantViews.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "BronchoscopyNavigatorQuadrantViews.h"

namespace igstk
{

BronchoscopyNavigatorQuadrantViews::BronchoscopyNavigatorQuadrantViews(int X, int Y, int W, int H, const char *L)
  : Fl_Group(X, Y, W, H, L)
{
...
BronchoscopyNavigatorQuadrantViews::~BronchoscopyNavigatorQuadrantViews()
{
//  m_Displays.clear();
//  m_Views.clear();
  m_Sliders.clear();
...
void BronchoscopyNavigatorQuadrantViews::RequestResliceImage(void)
{
...
void BronchoscopyNavigatorQuadrantViews::cb_SuperiorLeftSlider_i(Fl_Value_Slider*, void*)
{
  this->redraw();
  this->RequestResliceImage();
}

void BronchoscopyNavigatorQuadrantViews::cb_SuperiorLeftSlider(Fl_Value_Slider* o, void* v)
{
  ((BronchoscopyNavigatorQuadrantViews*)(o->parent()))->cb_SuperiorLeftSlider_i(o,v);
}

void BronchoscopyNavigatorQuadrantViews::cb_SuperiorRightSlider_i(Fl_Value_Slider*, void*)
{
  this->redraw();
  this->RequestResliceImage();
}

void BronchoscopyNavigatorQuadrantViews::cb_SuperiorRightSlider(Fl_Value_Slider* o, void* v)
{
  ((BronchoscopyNavigatorQuadrantViews*)(o->parent()))->cb_SuperiorRightSlider_i(o,v);
}

void BronchoscopyNavigatorQuadrantViews::cb_InferiorLeftSlider_i(Fl_Value_Slider*, void*)
{
  this->redraw();
  this->RequestResliceImage();
}

void BronchoscopyNavigatorQuadrantViews::cb_InferiorLeftSlider(Fl_Value_Slider* o, void* v)
{
  ((BronchoscopyNavigatorQuadrantViews*)(o->parent()))->cb_InferiorLeftSlider_i(o,v);
}

unsigned long BronchoscopyNavigatorQuadrantViews::AddObserver(
  const ::itk::EventObject & event, ::itk::Command * observer )
{
  return m_Reporter->AddObserver( event, observer );
}

void BronchoscopyNavigatorQuadrantViews::RemoveObserver( unsigned long tag )
{
  m_Reporter->RemoveObserver( tag );
}

void BronchoscopyNavigatorQuadrantViews::RemoveAllObservers()
{
  m_Reporter->RemoveAllObservers();
}

int BronchoscopyNavigatorQuadrantViews::handle(int event)
{
  switch (event) 
  {      
        case FL_KEYUP:
...
void BronchoscopyNavigatorQuadrantViews::RequestUpdateOverlays()
{
