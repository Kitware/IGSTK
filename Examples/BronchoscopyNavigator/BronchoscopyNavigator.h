/*=========================================================================
  ...
  Module:    BronchoscopyNavigator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "BronchoscopyNavigatorGUI.h"
...
/** \class BronchoscopyNavigator
*
* \brief Implementation class for BronchoscopyNavigatorGUI.
*
* This class implements the main application.
*
*/
class BronchoscopyNavigator : public BronchoscopyNavigatorGUI
{
public:

  /** Typedefs */
  igstkStandardClassBasicTraitsMacro( BronchoscopyNavigator, BronchoscopyNavigatorGUI );
  ...
  * used to represent the tracked tool */
  ...
  typedef itk::MemberCommand<BronchoscopyNavigator>               ProgressCommandType;
  ...
  virtual ~BronchoscopyNavigator();

private:

  BronchoscopyNavigator(const Self&); // purposely not implemented
  ...
  public:
    ...
    void SetParent(BronchoscopyNavigator *p);
  ...
  private:
    BronchoscopyNavigator *m_Parent;
    bool m_ErrorOccured;
