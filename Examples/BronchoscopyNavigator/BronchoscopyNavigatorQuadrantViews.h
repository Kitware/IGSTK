/*=========================================================================
  ...
  Module:    BronchoscopyNavigatorQuadrantViews.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __BronchoscopyNavigatorQuadrantViews_h
#define __BronchoscopyNavigatorQuadrantViews_h
...
/** \class BronchoscopyNavigatorQuadrantViews
* 
...
class BronchoscopyNavigatorQuadrantViews : public Fl_Group {
public:

  BronchoscopyNavigatorQuadrantViews(int X, int Y, int W, int H, const char *L = 0);

  virtual ~BronchoscopyNavigatorQuadrantViews(void);
