/*=========================================================================
  ...
  Module:    igstkPointerUltrasoundCalibration.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef _igstkPointerUltrasoundCalibration_h
#define _igstkPointerUltrasoundCalibration_h
...
/** \class PointerUltrasoundCalibration
 * 
 ...
 *
 *  \image html  igstkPointerUltrasoundCalibration.png  "PointerUltrasoundCalibration State Machine Diagram"
 *  \image latex igstkPointerUltrasoundCalibration.eps  "PointerUltrasoundCalibration State Machine Diagram" 
 *
 * \ingroup Calibration
 */

class PointerUltrasoundCalibration : public Object
{
public:

  /** Macro with standard traits declarations. */
  igstkStandardClassTraitsMacro( PointerUltrasoundCalibration, Object );
...
public:
  ...
  igstkGetMacro( ValidPointerUltrasoundCalibration, bool );
...
protected:
  ...
  /** Constructor */
  PointerUltrasoundCalibration();

  /** Destructor */
  virtual ~PointerUltrasoundCalibration();
...
private:
  ...
  bool                              m_ValidPointerUltrasoundCalibration;
