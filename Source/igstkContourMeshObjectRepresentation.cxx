/*=========================================================================
  ...
  Module:    igstkContourMeshObjectRepresentation.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
::ContourMeshObjectRepresentation():m_StateMachine(this)
{
...
/** Destructor */
ContourMeshObjectRepresentation::~ContourMeshObjectRepresentation()  
{
...
void ContourMeshObjectRepresentation::NoProcessing()
{
}


/** Set the Cylindrical Spatial Object */
void ContourMeshObjectRepresentation::SetMeshObjectProcessing()
{
  // We create the ellipse spatial object
...
void ContourMeshObjectRepresentation::CreateActors()
{
  ...
  for(;it_cells != cells->End();it_cells++)
    ...
    switch( ptsSize )
      ...
      case 4: 
        ...
        break;
      default:
        igstkLogMacro( CRITICAL, "ContourMeshObjectRepresentation: "
...
ContourMeshObjectRepresentation::Pointer
ContourMeshObjectRepresentation::Copy() const
{
  Pointer newOR = ContourMeshObjectRepresentation::New();
