...
AuroraTrackerNew::ResultType AuroraTrackerNew
::VerifyTrackerToolInformation( TrackerToolType * trackerTool )
{
  ...
  //
  igstkLogMacro( DEBUG, "AuroraTrackerNew::VerifyTrackerToolInformation called ...\n");
  ...
  if( SROMFileSpecified ) 
    ...
    if (!sromFile.is_open())
      {
      igstkLogMacro( WARNING, "AuroraTrackerNew::Failing to open"
                     << SROMFileName << " ...\n");
      return FAILURE;
      }
