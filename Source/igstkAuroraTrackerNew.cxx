/*=========================================================================
  ...
  Module:    igstkAuroraTrackerNew.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
AuroraTrackerNew::AuroraTrackerNew(void):m_StateMachine(this)
{
...
/** Destructor */
AuroraTrackerNew::~AuroraTrackerNew(void)
{
}

/** Helper function for reporting interpreter errors. */
AuroraTrackerNew::ResultType
AuroraTrackerNew::CheckError(CommandInterpreterType *interpreter)
{
...
void AuroraTrackerNew::SetCommunication( CommunicationType *communication )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew:: Entered SetCommunication ...\n");
  ...
  igstkLogMacro( DEBUG, "AuroraTrackerNew:: Exiting SetCommunication ...\n"); 
}

/** Open communication with the tracking device. */
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalOpen( void )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalOpen called ...\n");

  ResultType result = SUCCESS;

  if (!m_Communication)
    {
    igstkLogMacro( CRITICAL, "AuroraTrackerNew: AttemptToOpen before "
...
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalClose called ...\n");
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalActivateTools( void )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalActivateTools called ...\n");
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalDeactivateTools( void )
{
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalStartTracking( void )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalStartTracking called ...\n");  
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalStopTracking( void )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalStopTracking called ...\n");
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalReset( void )
{
  m_CommandInterpreter->RESET();
  m_CommandInterpreter->INIT();
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalUpdateStatus()
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalUpdateStatus called ...\n");
  ...
  for (unsigned int port = 0; port < NumberOfPorts; port++) 
    ...
    for (unsigned int channel = 0; channel < NumberOfChannels; channel++)
      ...
      if (normsquared < 1e-6)
        ...
        igstkLogMacro( WARNING, "AuroraTrackerNew::InternUpdateStatus: bad "
...
AuroraTrackerNew::ResultType AuroraTrackerNew::InternalThreadedUpdateStatus( void )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::InternalThreadedUpdateStatus "
                 "called ...\n");
...
void AuroraTrackerNew::AttachSROMFileNameToPort( const unsigned int portNum,
                                              std::string fileName )
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::AttachSROMFileNameToPort called..\n");
...
bool AuroraTrackerNew::LoadVirtualSROM( const unsigned int port,
                                     const std::string SROMFileName) 
{
  igstkLogMacro( DEBUG, "AuroraTrackerNew::LoadVirtualSROM called...\n");
  ...
  if (!sromFile.is_open())
    {
    igstkLogMacro( WARNING, "AuroraTrackerNew::LoadVirtualSROM: couldn't "
...
/** Enable all tool ports that are occupied.
  ...
  * Guide */
void AuroraTrackerNew::EnableToolPorts()
{
...
void AuroraTrackerNew::DisableToolPorts( void )
{
...
/** Print Self function */
void AuroraTrackerNew::PrintSelf( std::ostream& os, itk::Indent indent ) const
{
