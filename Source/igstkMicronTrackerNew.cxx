/*=========================================================================
  ...
  Module:    igstkMicronTrackerNew.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
/** Destructor */
MicronTrackerNew::~MicronTrackerNew(void)
{
  if ( m_Cameras != NULL )
    {
    delete m_Cameras;
...
void MicronTrackerNew::SetCameraCalibrationFilesDirectory( std::string fileName )
{
  igstkLogMacro( DEBUG,
                "MicronTrackerNew::SetCameraCalibrationFilesDirectory called..\n");

  m_CalibrationFilesDirectory = fileName;
}

/** Specify the initialization filename */
void MicronTrackerNew::SetInitializationFile( std::string fileName )
{
  igstkLogMacro( DEBUG,
                "MicronTrackerNew::SetInitializationFileDirectoryPath called..\n");
...
void
MicronTrackerNew::LoadMarkerTemplate( std::string filename )
{
  igstkLogMacro( DEBUG,
                "MicronTrackerNew::LoadMarkerTemplate called..\n");
...
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::InternalOpen called ...\n");
...
bool MicronTrackerNew::Initialize()
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::Initialize called ...\n");
...
bool MicronTrackerNew::SetUpCameras()
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::SetUpCameras called ...\n");
...
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::InternalStartTracking called ...\n");  
...
MicronTrackerNew::ResultType MicronTrackerNew::InternalStopTracking( void )
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::InternalStopTracking called ...\n");
...
MicronTrackerNew::ResultType MicronTrackerNew::InternalReset( void )
{
...
MicronTrackerNew::ResultType MicronTrackerNew::InternalUpdateStatus()
{
  igstkLogMacro( DEBUG, "MicronTrackerNew::InternalUpdateStatus called ...\n");
...
MicronTrackerNew::ResultType MicronTrackerNew::InternalThreadedUpdateStatus( void )
{
