#include "igstkUSCalibrationPlanePhantomAlgorithm.h"
...
USCalibrationPlanePhantomAlgorithm::USCalibrationPlanePhantomAlgorithm()
{
}
...
bool
USCalibrationPlanePhantomAlgorithm::InternalComputeCalibrationProcessing()
{
  ...
  typedef lsqrRecipes::PlanePhantomUSCalibrationParametersEstimator::DataType lsqrRecipesDataType; 
  ...
  else 
  {
    ...
    this->m_TransformData->RequestInitialize( transform, estimationDate,
                                              std::string("US Calibration - Plane/Wall Phantom"),  
