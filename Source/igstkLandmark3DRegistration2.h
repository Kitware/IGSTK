/*=========================================================================
  ...
  Module:    igstkLandmark3DRegistration2.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __igstkLandmark3DRegistration2_h
#define __igstkLandmark3DRegistration2_h
 ...
 *
 * Furthermore, if the two provided set of points differ in size, a permutation
 * is performed using the least number of elements in the two set of points. The 
 * iteration escapes when a reasonable small registration error is achieved.  
 *
...
class Landmark3DRegistration2 : public Object
{

public:
  
  /** Macro with standard traits declarations. */
  igstkStandardClassTraitsMacro( Landmark3DRegistration2, Object )
...
private:
  ...
  Landmark3DRegistration2(const Self&);    //purposely not implemented
  ...
  LandmarkPointContainerType               m_AuxTrackerLandmarks;
  LandmarkPointContainerType               m_ImageLandmarks;
  LandmarkPointContainerType               m_AuxImageLandmarks;
...
#endif // __igstkLandmark3DRegistration2_h
