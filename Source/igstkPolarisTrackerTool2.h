/*=========================================================================
  ...
  Module:    igstkPolarisTrackerTool2.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __igstkPolarisTrackerTool2_h
#define __igstkPolarisTrackerTool2_h
...
class PolarisTrackerTool2 : public TrackerTool
{
public:

  /** Macro with standard traits declarations. */
  igstkStandardClassTraitsMacro( PolarisTrackerTool2, TrackerTool )
   ...
   * tracker. */
  virtual void RequestAttachToTracker( PolarisTracker2 * );
...
private:
  ...
  PolarisTrackerTool2(const Self&);   //purposely not implemented
...
#endif  // __igstk_PolarisTrackerTool2_h_
